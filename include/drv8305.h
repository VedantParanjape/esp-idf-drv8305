...
} drv8305_status_01_reg_t __attribute__((packed));
...
} drv8305_status_02_reg_t __attribute__((packed));
...
} drv8305_status_03_reg_t __attribute__((packed));
...
} drv8305_status_04_reg_t __attribute__((packed));
